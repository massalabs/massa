...
//!
//! if we consider only 5 votes, the probability that a 30%-stake was selected to vote at least 50% of the times is 16%
//! if we consider 1000 votes that probability falls to 5e-40.
//!
//! # Notes on MipState
//!
//! MipState has:
