...
machine!(
    ...
    pub(crate) enum ComponentState {
        /// Initial state
        Defined,
        /// Past start, can only go to LockedIn after the vote ratio is above a given value
...
mod test {
    ...
    fn test_is_consistent_with() {
        // Test MipStateHistory::is_consistent_with (coherence of MIP state against its MIP info)
