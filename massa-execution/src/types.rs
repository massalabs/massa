...
pub(crate) struct StepHistoryItem {
    ...
    // events produced during this step, in chronological order
...
pub(crate) struct ExecutionContext {
    ...
    /// operation ID that triggered the call, if any
    ...
    /// generated events during this execution in chronological order
    pub events: Vec<SCOutputEvent>,
...
pub(crate) enum ExecutionRequest {
    ...
    Shutdown,
    /// Get events with filter criteria
    GetSCOutputEvents {
