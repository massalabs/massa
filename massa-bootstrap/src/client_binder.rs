...
use massa_models::constants::default::{
    ...
    MAX_DATA_ASYNC_MESSAGE, MAX_FUNCTION_NAME_LENGTH, MAX_LEDGER_CHANGES_COUNT,
    MAX_LEDGER_CHANGES_PER_BLOCK, MAX_PARAMETERS_SIZE, MAX_PRODUCTION_EVENTS_PER_BLOCK,
    MAX_PRODUCTION_STATS_LENGTH, MAX_RNG_SEED_LENGTH, MAX_ROLLS_COUNTS_LENGTH,
