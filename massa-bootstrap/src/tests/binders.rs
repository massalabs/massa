...
use massa_models::config::{
    ...
    MAX_DENUNCIATIONS_PER_BLOCK_HEADER, MAX_DE_CHANGES_LENGTH, MAX_EXECUTED_OPS_CHANGES_LENGTH,
    MAX_EXECUTED_OPS_LENGTH, MAX_LEDGER_CHANGES_COUNT, MAX_OPERATIONS_PER_BLOCK,
...
impl<D: Duplex> BootstrapClientBinder<D> {
    pub fn test_default(client_duplex: D, remote_pubkey: PublicKey) -> Self {
        let cfg = BootstrapClientConfig {
            ...
            max_de_changes_length: MAX_DE_CHANGES_LENGTH,
        };
