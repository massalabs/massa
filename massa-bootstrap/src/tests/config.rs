...
use massa_models::{
    config::{
        ...
        MAX_PARAMETERS_SIZE, MAX_PRODUCTION_STATS_LENGTH,
        MAX_RECEIVED_BOOTSTRAP_FINAL_STATE_ELEMENTS_COUNT,
        MAX_RECEIVED_BOOTSTRAP_VERSIONING_ELEMENTS_COUNT, MAX_ROLLS_COUNT_LENGTH,
        MIP_STORE_STATS_BLOCK_CONSIDERED, PERIODS_PER_CYCLE, T0, THREAD_COUNT,
    },
    node::NodeId,
};
...
impl Default for BootstrapConfig {
    fn default() -> Self {
        ...
        BootstrapConfig {
            ...
            // mirrors the node: these bound what a client accepts, not what a server sends
            max_final_state_elements_count: MAX_RECEIVED_BOOTSTRAP_FINAL_STATE_ELEMENTS_COUNT,
            max_versioning_elements_count: MAX_RECEIVED_BOOTSTRAP_VERSIONING_ELEMENTS_COUNT,
