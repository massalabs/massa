...
use massa_models::{
    config::{
        bootstrap_batch_allocation_budget, BOOTSTRAP_RANDOMNESS_SIZE_BYTES,
        ...
        MAX_BOOTSTRAP_VERSIONING_ELEMENTS_SIZE, MAX_CONSENSUS_BLOCKS_IDS,
        ...
        MAX_ROLLS_COUNT_LENGTH, MIP_STORE_STATS_BLOCK_CONSIDERED, PERIODS_PER_CYCLE, T0,
        THREAD_COUNT,
    },
    node::NodeId,
};
...
impl Default for BootstrapConfig {
    fn default() -> Self {
        ...
        BootstrapConfig {
            ...
            // mirrors the node: bounds a batch we receive, not one we send
