...
use massa_models::config::{
    ...
    MAX_ADVERTISE_LENGTH, MAX_BOOTSTRAPPED_NEW_ELEMENTS, MAX_BOOTSTRAPPED_NEW_ELEMENTS_SIZE,
    MAX_BOOTSTRAP_BLOCKS, MAX_BOOTSTRAP_ERROR_LENGTH, MAX_CONSENSUS_BLOCKS_IDS,
