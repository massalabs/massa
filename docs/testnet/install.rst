...
- `Windows executable <https://github.com/massalabs/massa/releases/download/TEST.11.1/massa_TEST.11.1_release_windows.zip>`_
- `Linux binary <https://github.com/massalabs/massa/releases/download/TEST.11.1/massa_TEST.11.1_release_linux.tar.gz>`_ - only work with libc2.28 at least (for example Ubuntu 20.04 and higher)
- `MacOS binary <https://github.com/massalabs/massa/releases/download/TEST.11.1/massa_TEST.11.1_release_macos.tar.gz>`_
