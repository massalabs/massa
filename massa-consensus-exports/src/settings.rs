...
pub struct ConsensusSettings {
    ...
    pub operation_batch_announcement_size: usize,
...
pub struct ConsensusConfig {
    ...
    pub operations_announcement_size: usize,
    pub initial_rolls_path: PathBuf,
...
impl Clone for ConsensusConfig {
    fn clone(&self) -> Self {
        Self {
            ...
            operations_announcement_size: self.operations_announcement_size,
...
impl From<&ConsensusSettings> for ConsensusConfig {
    fn from(settings: &ConsensusSettings) -> Self {
        ...
        ConsensusConfig {
            ...
            operations_announcement_size: settings.operation_batch_announcement_size,
...
impl Default for ConsensusSettings {
    fn default() -> Self {
        ...
        Self {
            ...
            operation_batch_announcement_size: OPERATION_BATCH_ANNOUNCEMENT_SIZE,
...
impl Default for ConsensusConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            initial_ledger_path: Default::default(),
            block_reward: BLOCK_REWARD,
            operations_announcement_size: OPERATION_BATCH_ANNOUNCEMENT_SIZE,
            initial_rolls_path: Default::default(),
            initial_draw_seed: INITIAL_DRAW_SEED.to_string(),
            roll_price: ROLL_PRICE,
            stats_timespan: *STATS_TIMESPAN,
