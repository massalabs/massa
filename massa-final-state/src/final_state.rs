...
/// Represents a final state `(ledger, async pool, executed_ops, processed denunciations and the state of the PoS)`
...
impl FinalState {
    ...
    pub fn get_state_changes_part(
        ...
        denunciations_step: StreamingStep<Slot>,
        ...
        for (slot, changes) in self.changes_history.range((position_slot as usize)..) {
            ...
            if denunciations_step.finished() {
