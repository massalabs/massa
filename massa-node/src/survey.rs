                    ...
                    .spawn(move || loop {
                        select! {
                            ...
                            recv(update_tick) -> _ => {
                                ...
                                {
                                    massa_metrics.set_operations_pool(pool_controller.get_operation_count(None).unwrap_or(0));
                                    massa_metrics.set_endorsements_pool(pool_controller.get_endorsement_count(None).unwrap_or(0));
                                    massa_metrics.set_denunciations_pool(pool_controller.get_denunciation_count(None).unwrap_or(0));
