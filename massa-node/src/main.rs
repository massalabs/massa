...
async fn launch(
    ...
    let mip_0002_start = MassaTime::from_utc_ymd_hms(2023, 6, 16, 14, 41, 0).unwrap();
    let mip_0002_timeout = MassaTime::from_utc_ymd_hms(2023, 6, 19, 15, 59, 0).unwrap();
    let mip_0002_defined_start = MassaTime::from_utc_ymd_hms(2023, 6, 19, 14, 40, 0).unwrap();
