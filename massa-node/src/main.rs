...
use massa_models::config::constants::{
    ...
    LEDGER_ENTRY_DATASTORE_BASE_SIZE, MAX_ADVERTISE_LENGTH, MAX_API_DATASTORE_KEYS_QUERY,
    MAX_ASYNC_GAS, MAX_ASYNC_POOL_LENGTH, MAX_BLOCK_SIZE, MAX_BOOTSTRAP_BLOCKS,
...
async fn launch(
    ...
    let api_config: APIConfig = APIConfig {
        ...
        minimal_fees: SETTINGS.pool.minimal_fees,
        deferred_calls_config,
        max_datastore_keys_queries: MAX_API_DATASTORE_KEYS_QUERY,
    };
