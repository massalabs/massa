...
use massa_models::address::{Address, AddressV2};
...
fn test_active_history_deferred_credits() {
    ...
    let addr1 = Address::AddressV2(AddressV2(HashV2::compute_from("A1".as_bytes())));
    let addr2 = Address::AddressV2(AddressV2(HashV2::compute_from("A2".as_bytes())));
