...
mod tests {
    ...
    fn vesting_transfer_coins() {
        ...
        assert!(events[0]
            .data
            .contains("total coin value 60000 fell under the minimal vesting value 100000"));
    ...
    fn vesting_max_rolls() {
        ...
        assert!(events[0].data.contains(
            "trying to get to a total of 160 rolls but only 50 are allowed at that time by the vesting scheme"
        ));
