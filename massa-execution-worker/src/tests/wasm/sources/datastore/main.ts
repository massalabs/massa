...
export function main(_args: string): void {
    ...
    let key1: Uint8Array = new Uint8Array(2);
    key1.set([65, 66]);
    let key2: Uint8Array = new Uint8Array(7);
    key2.set([0, 0, 1, 1, 11, 11, 99]);
    ...
    let key3: Uint8Array = new Uint8Array(1);
    key3.set([9,]);
    let data_key_1: Uint8Array = getOpData(key1);
    let data_key_3: Uint8Array = getOpData(key3);
