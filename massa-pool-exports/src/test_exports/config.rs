...
impl Default for PoolConfig {
    fn default() -> Self {
        Self {
            ...
            operation_pool_swap_interval: MassaTime::from_millis(100),
            endorsement_pool_swap_interval: MassaTime::from_millis(100),
            denunciation_pool_refresh_interval: MassaTime::from_millis(2000),
            denunciation_pool_swap_interval: MassaTime::from_millis(100),
