...
use crate::{controller_traits, settings::PoolConfig, PoolCommandSender, PoolManager};
use futures::Future;
use massa_hash::Hash;
use massa_models::{
    ...
    V: Future<Output = (MockProtocolController, PoolCommandSender, PoolManager)>,
{
    ...
    let (pool_command_sender, pool_manager) = controller_traits::start_pool_controller(
        cfg,
