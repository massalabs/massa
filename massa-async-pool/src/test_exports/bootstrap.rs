...
use massa_models::{address::Address, amount::Amount, config::constants::THREAD_COUNT, slot::Slot};
...
pub(crate) fn assert_eq_async_message(v1: &AsyncMessage, v2: &AsyncMessage) {
